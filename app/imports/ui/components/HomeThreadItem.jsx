  ...
  <>
    <a href={`/thread/${thread._id}`} style={{ textDecoration: 'none' }}>
      <Row className="mb-2 align-items-left" style={{ textAlign: 'left' }}>
        ...
        <p style={{ position: 'absolute', paddingLeft: '4em' }}>{thread.owner} | {thread.messages[0].time.toLocaleDateString('en-us', { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric' })}</p>
