...
const ModelDiscussionItem = ({ item }) => {
  ...
  return (
    <a href={`/model/${item._id}`} style={{ textDecoration: 'none', color: 'black' }}>
      <Container style={containerStyle} className="d-block model-discussion-item mb-4">
...
export default ModelDiscussionItem;
